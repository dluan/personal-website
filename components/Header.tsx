...
const workLinks = [
  ...
  { title: 'Área de trabalho', href: '/area-de-trabalho' },
...
export default function Header() {
  ...
  return (
    <header className={clsx('fixed top-0 right-0 left-0 z-[1000]', 'fm:absolute')}>
      <div
        className={clsx(
          'fixed inset-0 h-16',
          [
      ...
      <div className={clsx('content-wrapper-max')}>
        <div className={clsx('relative z-50 flex h-16 items-center justify-between px-2 text-sm', 'md:px-4')}>
          <nav className={clsx('flex', 'md:gap-2')} data-accent="violet">
            ...
            <ul className={clsx('flex items-center', 'md:gap-1')}>
              ...
              <li className={clsx('lg:hidden')} data-accent="blue">
                <NavLinkDropdown title="Trabalho" items={workLinks} />
              </li>
              <li className={clsx('hidden lg:block')} data-accent="blue">
                <NavLinkExpanded title="Trabalho" items={workLinks} />
              </li>
            </ul>
          </nav>
