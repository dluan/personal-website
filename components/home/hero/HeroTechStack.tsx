...
import { Hygraph, NextJsIcon, ReactIcon, TailwindCssIcon, TypeScriptIcon, VSCodeIcon } from '@/components/Icons'
...
export default function HeroTechStack() {
  return (
    <div>
      ...
      >
        atuais tecnologias e ferramentas preferidas:
      </m.p>
      <m.ul
        className={clsx('flex items-center gap-3.5 text-slate-500', 'dark:text-slate-500')}
        initial="hide"
        animate="show"
      ...
      >
        ...
        <m.li variants={animation}>
          <div
            title="Next.js"
            className={clsx('transition duration-200 hover:text-[#000000] dark:hover:text-[#FFFFFF]')}
          >
        ...
        <m.li variants={animation}>
          <div
            ...
            className={clsx('transition duration-200 hover:text-[#000000] dark:hover:text-[#FFFFFF]')}
          >
            <Hygraph className={clsx('h-6 w-6')} />
          </div>
        </m.li>
        <m.li variants={animation}>
