...
function ButtonResume() {
  return (
    <a
      ...
      href="/assets/Denner Luan CV - Front End.pdf"
  ...
  return (
    ...
    >
      <span className={clsx('relative flex h-2 w-2')}>
        ...
        />
        <span className={clsx('bg-accent-500 relative inline-flex h-2 w-2 rounded-full', 'dark:bg-accent-400')} />
      </span>
...
export default function HeroCta({ isFree = true, isFreeAnimationDuration = 4 }: HeaderCtaProps) {
