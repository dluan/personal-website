...
function TodoItem({
  ...
  description = 'Após o desenvolvimento, criar uma documentação para o cliente',
  date = '10:00 · Amanhã',
  tag1 = 'Doc',
  tag2 = 'Suporte'
}: TodoItemProps) {
    ...
    <div
      className={clsx(
        ...
        state.includes('colors')
          ? ['border-divider-light bg-white', 'dark:border-divider-dark dark:bg-slate-900']
          : ['border-black bg-white', 'dark:border-white dark:bg-[#050914]']
      )}
      role="presentation"
    >
      <div className={clsx('flex items-center', state.includes('spacing') && ['mb-4 justify-between'])}>
