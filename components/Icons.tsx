...
export function LightIcon(props: ComponentProps<'svg'>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" role="img" fill="currentColor" {...props}>
...
export function VercelIcon(props: ComponentProps<'svg'>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" role="img" fill="currentColor" {...props} viewBox="0 0 512 512">
...
export function Hygraph(props: ComponentProps<'svg'>) {
  return (
    <svg
      fill="currentColor"
      viewBox="0 0 22 32"
      xmlns="http://www.w3.org/2000/svg"
      className="h-[32px] max-w-[116px] fill-current"
      {...props}
    >
      <title>Hygraph Icon</title>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M14.9 4.267 11.175 6.4 7.45 8.533l-3.725 2.134v12.8l3.725-2.134 3.725-2.133v-4.267L7.45 17.067V12.8l3.725-2.133L14.9 8.533v12.8l-3.725 2.134L7.45 25.6l-3.725 2.133L0 29.866 3.725 32l3.725-2.134 3.725-2.133L14.9 25.6l3.726-2.133V2.133L14.9 0v4.267Z"
      />
    </svg>
  )
}
...
export function HashtagIcon(props: ComponentProps<'svg'>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" role="img" {...props}>
      <path
        fillRule="evenodd"
