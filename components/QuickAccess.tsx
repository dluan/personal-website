  ...
  return isQuickAccessOpen ? (
    ...
    >
      ...
      <div className={clsx('fixed inset-0')}>
        <Dialog.Panel>
          <div className={clsx('pointer-events-none absolute inset-x-4 top-8 flex justify-end', 'sm:inset-x-8')}>
            <button
              ref={closeButtonRef}
              type="button"
              className={clsx(
          ...
          >
            ...
            <div className={clsx('fixed left-8 bottom-10 hidden w-[320px]', 'md:block')}>
              <m.div
