...
function ActionCenter() {
  ...
  return (
    <m.div className={clsx('flex flex-col gap-2')} initial="hide" animate="show" transition={{ staggerChildren: 0.06 }}>
      ...
      <div className={clsx('flex flex-1 flex-col gap-8 p-2')}>
        <m.div className={clsx('flex h-24 gap-4')} variants={animation}>
          <ActionCenterButton
            ...
            icon={
              ...
              >
                <m.div
                  animate={
                    theme === 'dark' ? { opacity: [0.01, 1], scale: [0.801, 1] } : { opacity: [0, 1], scale: [0.8, 1] }
                  }
                  transition={{ ease: 'easeOut', duration: 0.8 }}
                ...
                <m.div
                  animate={
                    theme === 'dark' ? { opacity: [1, 0], scale: [1, 0.801] } : { opacity: [1, 0.01], scale: [1, 0.8] }
                  }
                  transition={{ ease: 'easeOut', duration: 0.8 }}
          ...
          />
          <ActionCenterButton
            title={focusMode ? 'Foco: Ligado' : 'Foco: Desligado'}
            onClick={() => {
