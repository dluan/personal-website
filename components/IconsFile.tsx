...
export function JavaScriptIcon(props: ComponentProps<'svg'>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 482.2 367.2" {...props}>
      <path
...
export function TypeScriptIcon(props: ComponentProps<'svg'>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24.94 16.43" {...props}>
      <path
...
export function HtmlIcon(props: ComponentProps<'svg'>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" {...props}>
      ...
      />
      <polygon fill="#D4843E" points="119.5,202.8 92,202.8 134.5,57.2 162,57.2" />
    </svg>
  )
}
...
export function ReactIcon(props: ComponentProps<'svg'>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 490.6 436.9" {...props}>
      <g fill="#61dafb">
...
export function NpmFileIcon(props: ComponentProps<'svg'>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 100" {...props}>
      <path d="m0 0v85.498h71.166v14.332h56.834v-14.332h128v-85.498z" fill="#cb3837" />
      <path
